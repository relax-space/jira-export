...
def main():
    ...
    from relax.p5 import start

    root_folder = "data1"
    pic_folder = "pic"
    in_file = os_path.join(root_folder, "raw", "raw.xlsx")
    in_file_log = os_path.join(root_folder, "raw", "raw_log.xlsx")
    # 根据项目查询
    project_keys = []
    ...
    try:
        start(out_folder, in_file, in_file_log, file_name, project_keys, params)
